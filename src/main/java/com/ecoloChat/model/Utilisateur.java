...
public class Utilisateur implements Serializable {
    ...
    public Utilisateur(Integer idUtilisateur, String nomUtilisateur, String prenomUtilisateur, String emailUtilisateur, String pwdUtilisateur, String pseudo, int actif, int idTypeUtilisateur) {
        this.idUtilisateur = idUtilisateur;
