...
public class ChatResource {
    ...
    public void onOpen(RemoteEndpoint r, EventBus eventBus) { 
        ...
        //System.out.println((room + "/*"+","+ new JSONObject(new Message(String.format("%s has entered the room ",  username).toString()), true))+"");
        eventBus.publish(room + "/*", new Message(String.format("%s vient de se connecter ",  username), true)); 
    } 
