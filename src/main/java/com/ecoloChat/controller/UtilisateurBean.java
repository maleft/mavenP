	  ...
	  private String username;
	    ...
	    public void login(ActionEvent event) {
	       ...
	       if(u!=null){
	    	   ...
	    	   FacesContext.getCurrentInstance().getApplication().getNavigationHandler().handleNavigation(FacesContext.getCurrentInstance(), null, "menugeneral?faces-redirect=true&id="+u.getIdUtilisateur());
	       }else {
